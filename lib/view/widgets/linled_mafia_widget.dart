...
class LinledMafiaWidget extends StatefulWidget {
  final LinkedmafiaController controller = Get.find<LinkedmafiaController>();

  LinledMafiaWidget({super.key});

  @override
  State<LinledMafiaWidget> createState() => _LanguageDropdownFieldState();
}

class _LanguageDropdownFieldState extends State<LinledMafiaWidget> {
